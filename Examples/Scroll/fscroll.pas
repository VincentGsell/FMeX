...
uses
  ...
  FMeX.Ticks, FMeX.Animation,
  FMeX.TileScrolling, System.Math.Vectors, FMX.Controls3D, FMX.StdCtrls,
...
begin
  Scroller :=  TTileScrolling.Create(nil);
